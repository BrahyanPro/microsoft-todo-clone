      ...
      >
        <div className={classes.drawerHeader}>
          ...
          <div className="moreinfo-body">
            <MoreInfoSteps selectedTask={selectedTask} />

            <Divider />

            <MoreInfoMyDay selectedTask={selectedTask} onClose={onClose} />

            <Divider />

            <MoreInfoPlanned selectedTask={selectedTask} tasks={tasks} />

            <Divider />

            <MoreInfoNote selectedTask={selectedTask} />
          </div>

          <MoreInfoFooter selectedTask={selectedTask} onClose={onClose} />
        </div>
      </Drawer>
    </Hidden>
  );
